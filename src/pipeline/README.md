...
Also ensure you have the `az ml` extension installed:
...
Update `src/pipeline/components/inference/inference-conda-env.yaml` with the requirements you need to run `src/pipeline/components/inference/inference.py`. Then create inference step AML conda environment:
...
Update `src/pipeline/components/score/score-conda-env.yaml` with the requirements you need to run `src/pipeline/components/inference/score.py`. Then create score step AML conda environment:
